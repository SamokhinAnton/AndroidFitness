...
namespace Fitness.EntityBase.Migrations
{
    ...
    [Migration("20181118120332_excatvirt")]
    partial class excatvirt
    {
            ...
            modelBuilder.Entity("Fitness.EntityBase.Entities.dbo.ExerciseCategoryEntity", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CategoryId = 1, Created = new DateTime(2018, 11, 18, 12, 3, 31, 946, DateTimeKind.Utc), ExerciseId = 1 },
                        new { Id = 2, CategoryId = 1, Created = new DateTime(2018, 11, 18, 12, 3, 31, 947, DateTimeKind.Utc), ExerciseId = 2 },
                        new { Id = 3, CategoryId = 1, Created = new DateTime(2018, 11, 18, 12, 3, 31, 947, DateTimeKind.Utc), ExerciseId = 3 }
                    );
                });
            ...
            modelBuilder.Entity("Fitness.EntityBase.Entities.dbo.UserEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("Created")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2018, 11, 18, 12, 3, 31, 937, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)));
